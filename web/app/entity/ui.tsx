...
// ✅ Evita React hydration mismatch (#418) ao renderizar datas em Client Components
  ...
  async function onSave(e: React.FormEvent) {
    ...
    const res = await fetch(`/api/entity/applications/${application.id}/update`, {
      ...
      body: JSON.stringify({
        ...
        // ✅ NOT NULL -> nunca enviar null (e evita NaN)
        requested_amount: requestedAmount.trim() ? Number(requestedAmount) : 0,
      }),
    });
