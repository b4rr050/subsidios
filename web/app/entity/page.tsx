...
export default async function EntityNewApplicationPage() {
  ...
  // category_id é NOT NULL -> escolher default
  ...
  if (!defaultCat?.id)
    redirect(`/entity?err=${encodeURIComponent("Não existem categorias ativas. Cria uma categoria antes de criar pedidos.")}`);
